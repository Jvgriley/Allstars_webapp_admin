...
import { navSections, type PageId } from "../nav";
                ...
                return (
                  <button
                    ...
                    className={cx(
                      ...
                      active ? "sa-gradient text-white shadow" : "text-white/70 hover:bg-white/10 hover:text-white",
                    )}
                  >
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="sticky top-0 z-20 flex items-center gap-3 border-b border-border bg-card/80 px-4 py-3 backdrop-blur">
          ...
          <button className="flex items-center gap-2 rounded-lg border border-border bg-card px-3 py-1.5 text-sm hover:bg-muted">
            <span className="grid size-6 place-items-center rounded-md sa-gradient text-[11px] font-bold text-white">R</span>
            <span className="hidden font-semibold sm:inline">{org.name}</span>
